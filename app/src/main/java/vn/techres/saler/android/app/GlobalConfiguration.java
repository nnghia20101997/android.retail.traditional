...
import com.core.app.base.delegate.AppLifecycles;
import com.core.app.di.module.GlobalConfigModule;
import com.core.app.http.imageloader.glide.GlideImageLoaderStrategy;
import com.core.app.http.log.FormatPrinter;
import com.core.app.http.log.RequestInterceptor;
import com.core.app.integration.ConfigModule;
...
import vn.techres.saler.android.BuildConfig;
 ...
 *
 * @see com.core.app.base.delegate.AppDelegate
 * @see com.core.app.integration.ManifestParser
...
//                })
                ...
                .formatPrinter(new FormatPrinter() {
                    ...
                    public void printJsonRequest(@NotNull Request request, @NotNull String bodyString) {
                        Timber.e("APIHeader: %s", ArmsUtils.obtainAppComponentFromContext(context).gson().toJson(request.headers()));
                        Timber.e("APIRequest: %s", bodyString);
                    }

                    @Override
                    public void printFileRequest(@NotNull Request request) {
                        Timber.e("APIFileRequest: %s", request.url().toString());
                    }

                    @Override
                    public void printJsonResponse(long chainMs, boolean isSuccessful, int code,
                                                  @NotNull String headers, MediaType contentType, String bodyString,
                                                  @NotNull List<String> segments, @NotNull String message, @NotNull String responseUrl) {
                        Timber.e("APIResponse: %s", bodyString);
                    }

                    @Override
                    public void printFileResponse(long chainMs, boolean isSuccessful, int code, @NotNull String headers,
                                                  @NotNull List<String> segments, @NotNull String message, @NotNull String responseUrl) {
                        Timber.e("APIFileResponse: %s", responseUrl);
                    }
                })
