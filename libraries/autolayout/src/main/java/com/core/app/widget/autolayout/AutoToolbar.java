...
public class AutoToolbar extends Toolbar {
    ...
    public AutoToolbar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        @SuppressLint("CustomViewStyleable") TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.Toolbar,
    ...
    private void setUpTitleTextSize(String name, int val) {
        try {
            ...
            Field f = Objects.requireNonNull(getClass().getSuperclass()).getDeclaredField(name);
